...
enum class CutType {PassingID, PlotPtError, PlotLayers, PlotPixelHits, PlotMuonHits, PlotMatchedStations, PlotTrackiso, PlotAbsDxy, PlotPtTune};
...
class ZprimeMuMuPatMiniAodNewMC
{
 public :
  ...
  const double ELEC_MASS= 0.000511;
  ...
  bool CutJets(unsigned jet);
  bool FollowupCut(unsigned jet);
  ...
  */
  ...
  bool FillMuonHistograms(CutType cutType);
  void RepeatedFillHistograms(bool isPri, int additive, int priEtaBin, int secEtaBin);
