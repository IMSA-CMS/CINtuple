...
//	dirInput="/lustre/cms/store/user/defilip/ZprimeAnalysis/Spring16_ZprimeEE_13TeV_merged_HLT";
//      else if (name.find("CMSSW803_MC_DYtoEE") < 100)
//	dirInput="/lustre/cms/store/user/defilip/ZprimeAnalysis/Spring16_merged";
...
//    std::cout << "weight is " << weight << std::endl;
  ...
  char* namechar = "/uscms/home/pdong/nobackup/test/CMSSW_8_0_25/src/ZprimeDiLeptons/Analyzer/test/MCBenchmark.root";

  float weight = 1;

  std::string dataconf = "2016";

  std::string mcconf = "supercalifragilisticexpialidocious"; 
  ...
  //dataconf must be "2016", weight is 1, mcconf can be any string. namechar is the full path to find the file, 
