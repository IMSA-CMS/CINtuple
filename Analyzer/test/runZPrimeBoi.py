...
sourceFiles = FileUtils.loadListFromFile('localRootMuM300Files.txt')#JOHN  TURN THIS ONE BACK ON 
#sourceFiles = FileUtils.loadListFromFile('fileQueryTestMuM300L16ConLL.txt') #THIS IS THE ROOT XD 
#for line in sourceFiles:
#    print(line)

sourceList = ['file:/uscms/physics_grp/lpcci2dileptons/nobackup/CI_study/Samples/Lambda_16TeV/CITo2Mu/LRCon/M300/' + line for line in sourceFiles]#JOHN TURN THIS ONE BACK ON
...
process.heepIdExample = cms.EDAnalyzer("MakeZprimeMiniAodTreeMC",
    ...
    lambda_ = cms.int32(16)  #This is in eV                                 
