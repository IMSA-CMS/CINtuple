...
def findHelicityInName(name):
    helicityReturnString = "isLRHelicity="
    ...
    while i < len(name) - 5:
        ...
        i += 1
    return helicityReturnString + "False";
...
#Moved this up here so we can still parse through the hardcoded string 
...
#inputDatasetString = sys.argv[4][18:]
inputDatasetString = config.Data.inputDataset

print("Set the input name: " + inputDatasetString)

helicityString = findHelicityInName(inputDatasetString)

print("Helicity String: " + helicityString)

print("We got to here")

lambdaString = findLambdaInName(inputDatasetString)

print("We got to here2")

config.JobType.pyCfgParams = [helicityString, lambdaString]
...
config.Data.outputDatasetTag = 'CI_M300_L' + lambdaString[0] + lambdaString[1] + 'TeV_' + findRealHelicityInName(inputDatasetString) + '_Con_NTuple_' + currTime
